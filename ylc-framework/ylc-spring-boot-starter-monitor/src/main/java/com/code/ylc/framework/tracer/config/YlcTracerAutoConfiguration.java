package com.code.ylc.framework.tracer.config;

import com.code.ylc.framework.common.enums.WebFilterOrderEnum;
import com.code.ylc.framework.tracer.core.aop.BizTraceAspect;
import com.code.ylc.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "ylc.tracer", value = "enable", matchIfMissing = true)
public class YlcTracerAutoConfiguration {
