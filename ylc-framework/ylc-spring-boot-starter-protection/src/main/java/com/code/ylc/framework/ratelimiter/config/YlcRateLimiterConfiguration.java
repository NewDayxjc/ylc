package com.code.ylc.framework.ratelimiter.config;

import com.code.ylc.framework.ratelimiter.core.aop.RateLimiterAspect;
import com.code.ylc.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import com.code.ylc.framework.ratelimiter.core.keyresolver.impl.*;
import com.code.ylc.framework.ratelimiter.core.redis.RateLimiterRedisDAO;
...
public class YlcRateLimiterConfiguration {
