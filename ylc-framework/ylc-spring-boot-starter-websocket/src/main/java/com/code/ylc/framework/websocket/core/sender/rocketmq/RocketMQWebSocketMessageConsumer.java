package com.code.ylc.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${ylc.websocket.sender-rocketmq.topic}",
        consumerGroup = "${ylc.websocket.sender-rocketmq.consumer-group}",
