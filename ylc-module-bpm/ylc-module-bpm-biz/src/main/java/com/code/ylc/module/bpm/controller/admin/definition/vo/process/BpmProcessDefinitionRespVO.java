package com.code.ylc.module.bpm.controller.admin.definition.vo.process;
...
public class BpmProcessDefinitionRespVO {
    ...
    @Schema(description = "流程标识", requiredMode = Schema.RequiredMode.REQUIRED, example = "ylc")
    private String key;

    @Schema(description = "流程图标", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.iocoder.cn/ylc.jpg")
    private String icon;
