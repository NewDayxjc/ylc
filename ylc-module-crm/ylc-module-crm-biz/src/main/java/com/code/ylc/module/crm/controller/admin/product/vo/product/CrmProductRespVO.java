package com.code.ylc.module.crm.controller.admin.product.vo.product;
...
public class CrmProductRespVO implements VO {
    ...
    @Trans(type = TransType.RPC, targetClassName = "com.code.ylc.module.system.dal.dataobject.user.AdminUserDO",
