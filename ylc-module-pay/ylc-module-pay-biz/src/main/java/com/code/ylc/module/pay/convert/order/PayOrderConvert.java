package com.code.ylc.module.pay.convert.order;
...
import com.code.ylc.module.pay.controller.admin.order.vo.*;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, com.code.ylc.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
