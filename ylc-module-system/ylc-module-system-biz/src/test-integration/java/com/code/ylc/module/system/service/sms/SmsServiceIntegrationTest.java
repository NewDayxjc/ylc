...
import com.code.ylc.framework.sms.config.YlcSmsAutoConfiguration;
import com.code.ylc.module.system.test.BaseDbAndRedisIntegrationTest;
...
// TODO @芋艿：需要迁移
@Import({YlcSmsAutoConfiguration.class,
