//package com.code.ylc.module.system.service.user;
//
...
//import com.code.ylc.framework.common.util.collection.ArrayUtils;
...
//import com.code.ylc.module.infra.api.file.FileApi;
//import com.code.ylc.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
//import com.code.ylc.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
//import com.code.ylc.module.system.controller.admin.user.vo.user.*;
//import com.code.ylc.module.system.dal.dataobject.dept.DeptDO;
//import com.code.ylc.module.system.dal.dataobject.dept.PostDO;
//import com.code.ylc.module.system.dal.dataobject.dept.UserPostDO;
//import com.code.ylc.module.system.dal.dataobject.tenant.TenantDO;
//import com.code.ylc.module.system.dal.dataobject.user.AdminUserDO;
//import com.code.ylc.module.system.dal.mysql.dept.UserPostMapper;
//import com.code.ylc.module.system.dal.mysql.user.AdminUserMapper;
//import com.code.ylc.module.system.enums.common.SexEnum;
//import com.code.ylc.module.system.service.dept.DeptService;
...
//import com.code.ylc.module.system.service.tenant.TenantService;
...
//        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("ylcyuanma");
//
//        // 调用
...
//        assertEquals("ylcyuanma", user.getPassword());
...
//        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
//        // mock passwordEncoder 的方法
//        when(passwordEncoder.encode(eq("ylcyuanma"))).thenReturn("java");
//
//        // 调用
//        UserImportRespVO respVO = userService.importUserList(newArrayList(importUser), true);
//        // 断言
