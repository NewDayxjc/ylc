//package com.code.ylc.module.infra.framework.file.core.s3;
//
...
//        config.setDomain("http://test.ylc.iocoder.cn"); // 如果有自定义域名，则可以设置。http://static.ylc.iocoder.cn
//        // 默认上海的 endpoint
