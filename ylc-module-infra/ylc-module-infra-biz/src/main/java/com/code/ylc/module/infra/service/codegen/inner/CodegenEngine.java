package com.code.ylc.module.infra.service.codegen.inner;
...
import com.code.ylc.framework.apilog.core.enums.OperateTypeEnum;
import com.code.ylc.framework.common.exception.util.ServiceExceptionUtil;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "ylc-module-${table.moduleName}/" + // 顶级模块
                "ylc-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "ylc-module-${table.moduleName}/" + // 顶级模块
                "ylc-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "ylc-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "ylc-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
