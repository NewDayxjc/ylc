...
import com.code.ylc.module.member.controller.app.user.vo.AppMemberUserUpdateMobileReqVO;
...
import com.code.ylc.module.member.service.auth.MemberAuthServiceImpl;
 ...
 */
@Disabled
@Import({MemberUserServiceImpl.class, YlcRedisAutoConfiguration.class})
