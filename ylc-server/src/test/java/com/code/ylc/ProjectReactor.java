...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.ylc";
    private static final String ARTIFACT_ID = "ylc";
    private static final String PACKAGE_NAME = "com.code.ylc";
    private static final String TITLE = "亚乐管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.ylc";
        String artifactIdNew = "ylc";
        String packageNameNew = "com.code.ylc";
        String titleNew = "亚乐管理系统";
